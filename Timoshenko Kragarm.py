...
for epoch in range(iterations):
    ...
    mse_bc_B = mse_cost_function(e1_B, pt_zero) + mse_cost_function(e2_B, pt_zero) + 1/normfactor * mse_cost_function(e3_B, pt_zero) + 1/normfactor * mse_cost_function(e4_B, pt_zero) + mse_cost_function(e5_B, pt_zero) + mse_cost_function(e6_B, pt_zero)
    mse_ode_B = 1/normfactor * mse_cost_function(ode_B, pt_all_zeros)
    mse_bc_S = mse_cost_function(e1_S, pt_zero) + 1/normfactor * mse_cost_function(e2_S, pt_zero) + mse_cost_function(e3_S, pt_zero)
